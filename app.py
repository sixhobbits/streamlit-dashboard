...
st.markdown("Filter by number of rooms and city below")
st.markdown("The average, median, min and max will update to reflect the filtered data, as well as the chart.")
